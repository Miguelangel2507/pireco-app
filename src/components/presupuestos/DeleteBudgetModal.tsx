...
export default function DeleteBudgetModal({ isOpen, onClose, budget, onDeleted }: Props) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Eliminar presupuesto">
      <div className="space-y-4">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          ...
          <span className="font-semibold text-gray-900 dark:text-white">{budget?.number}</span>?
